...
- 🌱 Currently deepening my knowledge of **DevOps** and **Cloud Computing** to build scalable systems
- 💬 Ask me about **Laravel, React, Spring Boot, Databases (SQL/NoSQL)**, or **Agile/Git workflows**
- 🛠️ Hands-on with database internals: concurrency control, serializability, and indexing structures
- 🎮 Outside of code: PC gaming enthusiast, deep into **Skyrim modding** with Mod Organizer 2 — load orders, conflict resolution, and all
